...
osg::Geode* createPyramid()
{
   ...
   colors->push_back(osg::Vec4(1.0f, 0.0f, 1.0f, 1.0f) ); //index 0 fuchsia
   colors->push_back(osg::Vec4(0.0f, 0.5f, 0.5f, 1.0f) ); //index 1 teal
   colors->push_back(osg::Vec4(0.2f, 1.0f, 0.0f, 1.0f) ); //index 2 lime
   colors->push_back(osg::Vec4(1.0f, 1.0f, 0.0f, 1.0f) ); //index 3 yellow
   colors->push_back(osg::Vec4(0.75f, 0.75f, 0.75f, 1.0f) ); //index 4 silver
   ...
   (*texcoords)[3].set(0.00f,0.0f); // tex coord for vertex 0 
   (*texcoords)[2].set(0.25f,0.0f); // tex coord for vertex 1 
