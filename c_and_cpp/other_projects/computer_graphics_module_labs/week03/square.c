...
void mouse(int btn, int state, int x, int y)
{
    ...
    else if(btn==GLUT_RIGHT_BUTTON && state==GLUT_DOWN) size = 7.0;
    else if(btn==GLUT_LEFT_BUTTON && state==GLUT_DOWN) size = 1.0;
    else if(btn==GLUT_MIDDLE_BUTTON && state==GLUT_DOWN) size = 3.0;
}
